...
def update_iftab_file(instance):
	f = utils.prepare_to_write('iftab', 'custom/network')
	...
	f.write("%s\t\t%s %s\n" % (instance.interface_name, 'mac', instance.interface_mac))
	f.close()

def update_interfaces_file(instance):
	f = utils.prepare_to_write('interfaces', 'custom/network')
...
def update_dns_file(instance):
	f = utils.prepare_to_write('resolv.conf', 'custom/network')
	
	# TODO: Criar função para estampar comentário de generated
	f.write("# DNS config\n")
	f.write("# Generated by Nimbus\n")
	f.write("nameserver %s\n" % instance.interface_dns1)
	f.write("nameserver %s\n" % instance.interface_dns2)
